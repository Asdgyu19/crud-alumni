...
func NewPekerjaanService() *PekerjaanService {
...
func (s *PekerjaanService) GetAllPekerjaanMongo(c *fiber.Ctx) error {
...
func (s *PekerjaanService) GetPekerjaanByIDMongo(c *fiber.Ctx) error {
	id := c.Params("id")
...
func (s *PekerjaanService) CreatePekerjaanMongo(c *fiber.Ctx) error {
...
func (s *PekerjaanService) UpdatePekerjaanMongo(c *fiber.Ctx) error {
	id := c.Params("id")
	var pekerjaan models.Pekerjaan
...
func (s *PekerjaanService) SoftDeletePekerjaanMongo(c *fiber.Ctx) error {
	id := c.Params("id")
...
func (s *PekerjaanService) HardDeletePekerjaanMongo(c *fiber.Ctx) error {
	id := c.Params("id")
...
func (s *PekerjaanService) GetTrashMongo(c *fiber.Ctx) error {
...
func (s *PekerjaanService) RestorePekerjaanMongo(c *fiber.Ctx) error {
	id := c.Params("id")
...
func (s *PekerjaanService) SearchPekerjaanMongo(c *fiber.Ctx) error {
	keyword := c.Query("q", "")
	page, _ := strconv.Atoi(c.Query("page", "1"))
	limit, _ := strconv.Atoi(c.Query("limit", "10"))
